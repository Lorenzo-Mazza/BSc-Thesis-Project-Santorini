 ...
 * There was a problem with the filesystem recognition while executing the JAR,
 * so we added a condition that creates a file system if no filesystem is detected
 */
